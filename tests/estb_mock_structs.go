...
func GetSetDaoGenericNamespacedList() (*core.GenericNamespacedList, error) {
	newList := core.NewGenericNamespacedList(NamespaceIPListKey, core.IpList, NamespaceIPList)
...
func GetModel1() *core.Model {
	modelStr := GetModelStr1()
	model := core.Model{}
	err := json.Unmarshal([]byte(modelStr), &model)
	if err != nil {
		panic(err)
	}
	return &model
}
func GetModel2() *core.Model {
	modelStr := GetModelStr2()
	model := core.Model{}
	err := json.Unmarshal([]byte(modelStr), &model)
	if err != nil {
		panic(err)
...
func GetModel3() *core.Model {
	modelStr := GetModelStr3()
	model := core.Model{}
	err := json.Unmarshal([]byte(modelStr), &model)
	if err != nil {
		panic(err)
...
func GetModel4() *core.Model {
	modelStr := GetModelStr4()
	model := core.Model{}
	err := json.Unmarshal([]byte(modelStr), &model)
	if err != nil {
		panic(err)
