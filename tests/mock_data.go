...
var (
  ...
  "applicationType": "stb"
	...
	RDKCLOUD_DOWNLOAD_LOCATION_ROUND_ROBIN_FILTER_VALUE_TEMPLATE = `{
     ...
     "httpLocation":"test.net",
     "httpFullUrlLocation":"https://test.net/Images"
    }`
	STB_DOWNLOAD_LOCATION_ROUND_ROBIN_FILTER_VALUE_TEMPLATE = `{
    "type":"com.comcast.xconf.estbfirmware.DownloadLocationRoundRobinFilterValue",
    "id":"stb_DOWNLOAD_LOCATION_ROUND_ROBIN_FILTER_VALUE",
    "updated":1615812930296,"applicationType":"stb",
    "locations":[{"locationIp":"96.114.220.246","percentage":100.0},{"locationIp":"69.252.106.162","percentage":0.0}],
    "ipv6locations":[{"locationIp":"2600:1f18:227b:c01:b161:3d17:7a86:fe36","percentage":50.0},{"locationIp":"2001:558:1020:1:250:56ff:fe94:646f","percentage":50.0}],
    "httpLocation":"test.net",
    "httpFullUrlLocation":"https://test.net/Images"
  }`
...
func GetModelStr1() string {
	return fmt.Sprintf(modelJsonTemplate1, ModelId1)
}

func GetModelStr2() string {
	return fmt.Sprintf(modelJsonTemplate2, ModelId2)
}

func GetModelStr3() string {
	return fmt.Sprintf(modelJsonTemplate3, ModelId3)
}

func GetModelStr4() string {
	return fmt.Sprintf(modelJsonTemplate4, ModelId4)
}
...
func GetRDKCDownloadLocationROUNDROBINFILTERVALUE() string {
	return fmt.Sprintf(RDKCLOUD_DOWNLOAD_LOCATION_ROUND_ROBIN_FILTER_VALUE_TEMPLATE, core.STB, IpAddress3, IpAddress4, IPAddressV61, IPAddressV62)
}
