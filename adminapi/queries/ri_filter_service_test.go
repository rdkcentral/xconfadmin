...
func TestUpdateRebootImmediatelyFilter_CreateAndUpdatePaths(t *testing.T) {
	...
	resp := UpdateRebootImmediatelyFilter(db.GetDefaultTenantId(), "stb", f)
...
func TestUpdateRebootImmediatelyFilter_ValidationFailures(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			resp := UpdateRebootImmediatelyFilter(tenantId, tc.app, tc.filter)
...
func TestDeleteRebootImmediatelyFilter_Paths(t *testing.T) {
	...
	assert.Equal(t, 201, resp.Status)
	// delete existing
	delResp := DeleteRebootImmediatelyFilter(db.GetDefaultTenantId(), "DELME", "stb")
...
func TestSaveRebootImmediatelyFilter_ErrorPaths(t *testing.T) {
	...
	_, err := SaveRebootImmediatelyFilter(db.GetDefaultTenantId(), f, "stb")
	assert.Error(t, err)
}
...
func TestSaveRebootImmediatelyFilter_AssignsAppType(t *testing.T) {
	...
	fr, err := SaveRebootImmediatelyFilter(db.GetDefaultTenantId(), f, "stb")
