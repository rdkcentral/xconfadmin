...
// 		if checkApplicationType && frule.ApplicationType != applicationType {
// 			continue
// 		}
...
// 		return nil, err
// 	}
// 	nameInUpperCase := strings.ToUpper(name)
...
// 			continue
// 		}
// 		if strings.ToUpper(frule.Name) == nameInUpperCase {
// 			fr := &IpFilter{
// 				Id:             frule.ID,
// 				Name:           frule.Name,
// 				IpAddressGroup: GetIpAddressGroup(frule.Rule.Condition),
